        ...
        <div class="container mx-auto">
            <div class="flex flex-col md:flex-row pb-4 mb-4">
                <div class="max-w-md p-6 bg-white rounded-lg shadow-md flex-1 mx-2 w-auto">
                    <h5 class="text-md font-semibold mb-4">Edit Category</h5>
                    <hr>
                    <form action="{{ route('update.category',['id'=>$categories->id]) }}" method="POST" class="w-full">
                        @csrf
                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                id="category-name" type="text" name="category_name" value="{{ $categories->category_name }}">
                            @error('category_name')
